...
_TIMELINE = {
    ...
    # ★2026-09-07 갱신: 7-16 2.75% · 8-27 3.00% 두 달 연속 인상(3년 반 만의 인상 전환). 출처: bok.or.kr 기준금리 추이 2026-09-07 웹검증.
    2026: ("OVERHEATED", "재긴축지속", "양극", "인상전환(7-16 2.75→8-27 3.00%)", "강남재과열"),
}
...
BOK_RATE = {2009: 2.00, 2010: 2.50, 2011: 3.25, 2012: 2.75, 2013: 2.50, 2014: 2.00,
            ...
            2026: 3.00}  # [사실] 2026-07-16 2.75%·08-27 3.00% 인상(그 전 8회 연속 동결). 연말값 = 09-07 시점 최신값, 10-22·11-26 결정 후 재확인. 출처: bok.or.kr 2026-09-07 웹검증
