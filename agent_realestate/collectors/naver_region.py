...
SEOUL_GU: dict[str, str] = {
    ...
    # ★2026-07-10 정정: 광진 1121000000→1121500000 · 금천 1154000000→1154500000 —
    #   LAWD 5번째 자리가 0이 아닌 두 구가 잘못 절단돼 있었음(라이브 검증: 구코드 오류 시 regionList 빈값,
    #   정정 후 광진 987·금천 655단지 열거). enumerate_25gu.py 실측에서 발견.
