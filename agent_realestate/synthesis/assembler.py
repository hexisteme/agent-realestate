...
.click-hint{font-size:11px;color:#4A6C8C;margin:2px 0 6px}"""
    ...
    # F_TOHER_RENT는 이제 서울 district 자동감지로 모든 서울 후보에 발화(risk.py 2026-06-13 재수정).
    ...
    if _seoul:
        H.append("<div class='box' style='border-left:5px solid #c0392b;background:#FDF0EE'>"
                 "<b>⚠️ 서울 전역 아파트 토지거래허가구역 (2025.10.20~2026.12.31)</b> — "
                 "서울 25개 자치구 전체 아파트 대상. <b>① 매수 시 허가 취득 필요 · ② 취득일로부터 2년 실거주의무</b>(이 기간 전세·임대 금지) · "
                 "<b>③ 자금조달계획서 의무</b>. "
                 "HOLD_AND_RENT 영향: '2년 실거주 후 임대' 타이밍 제약·즉시 갭투자(갭 끼기) 불가 "
                 "→ 자기자본 2년 잠김·현금흐름 계획 수정 필요. "
                 f"서울 후보 전체({len(_toher_flagged)}건)에 §5 F_TOHER_RENT 플래그 표시됨. "
                 "<span class=sub>출처: 정책브리핑 korea.kr · 10.15 부동산대책 · "
